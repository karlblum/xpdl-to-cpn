 ...
 * <ul>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.model.cpntypes.impl.CPNRecordImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CPNRecordImpl extends CPNTypeImpl implements CPNRecord {
	...
	protected EClass eStaticClass() {
		return CpntypesPackage.Literals.CPN_RECORD;
	}
	...
	public EList<NameTypePair> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<NameTypePair>(NameTypePair.class, this, CpntypesPackage.CPN_RECORD__VALUES);
		}
		return values;
	}
	...
	/**
	 * @see dk.au.daimi.ascoveco.cpn.model.cpntypes.CPNRecord#addValue(java.lang.String, java.lang.String)
	 */
