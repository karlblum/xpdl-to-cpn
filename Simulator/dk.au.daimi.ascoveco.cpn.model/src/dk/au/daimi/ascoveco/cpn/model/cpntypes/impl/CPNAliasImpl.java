 ...
 * <ul>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.model.cpntypes.impl.CPNAliasImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CPNAliasImpl extends CPNTypeImpl implements CPNAlias {
	...
	protected EClass eStaticClass() {
		return CpntypesPackage.Literals.CPN_ALIAS;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntypesPackage.CPN_ALIAS__TYPE, oldType, type));
	}
	...
	public String asString() {
		return getType() + postFixAsString();
	}
