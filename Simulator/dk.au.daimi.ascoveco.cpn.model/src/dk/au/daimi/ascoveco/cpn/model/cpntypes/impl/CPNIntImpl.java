 ...
 * <ul>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.model.cpntypes.impl.CPNIntImpl#getLow <em>Low</em>}</li>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.model.cpntypes.impl.CPNIntImpl#getHigh <em>High</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CPNIntImpl extends CPNTypeImpl implements CPNInt {
	...
	protected EClass eStaticClass() {
		return CpntypesPackage.Literals.CPN_INT;
	}
	...
	public void setLow(String newLow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntypesPackage.CPN_INT__LOW, oldLow, low));
	}
	...
	public void setHigh(String newHigh) {
		...
		high = newHigh;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpntypesPackage.CPN_INT__HIGH, oldHigh, high));
	}
