...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider extends PlaceNodeItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_references_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_references_feature", "_UI_Place_type"),
				 ModelPackage.Literals.PLACE__REFERENCES,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(final Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Place_type") : getString("_UI_Place_type") + " "
		        + label + " (" + netName + ')';
	}
