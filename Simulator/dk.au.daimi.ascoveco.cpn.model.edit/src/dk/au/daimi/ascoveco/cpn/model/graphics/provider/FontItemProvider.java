...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.graphics.Font} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FontItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_family_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_family_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__FAMILY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_style_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__STYLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_weight_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__WEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphicsPackage.Literals.FONT__SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addDecorationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_decoration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_decoration_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__DECORATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAlignPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_align_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_align_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__ALIGN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addRotationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_rotation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_rotation_feature", "_UI_Font_type"),
				 GraphicsPackage.Literals.FONT__ROTATION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Font)object).getFamily();
