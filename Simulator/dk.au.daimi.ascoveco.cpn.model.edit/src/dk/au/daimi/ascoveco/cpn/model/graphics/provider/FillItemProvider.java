...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.graphics.Fill} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FillItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fill_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fill_color_feature", "_UI_Fill_type"),
				 GraphicsPackage.Literals.FILL__COLOR,
				 true,
				 false,
				 false,
	...
	protected void addImagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fill_image_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fill_image_feature", "_UI_Fill_type"),
				 GraphicsPackage.Literals.FILL__IMAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGradientColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Fill_gradientColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Fill_gradientColor_feature", "_UI_Fill_type"),
				 GraphicsPackage.Literals.FILL__GRADIENT_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Gradient Rotation feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		String label = ((Fill)object).getColor();
