...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.cpntypes.CPNBool} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CPNBoolItemProvider
	 ...
	 * @generated
	 */
	public CPNBoolItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTrueValuePropertyDescriptor(object);
			addFalseValuePropertyDescriptor(object);
		}
	 ...
	 * @generated
	 */
	protected void addTrueValuePropertyDescriptor(Object object) {
	...
	/**
	 * This adds a property descriptor for the False Value feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addFalseValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CPNBool"));
	}
	...
	public String getText(Object object) {
		Boolean labelValue = ((CPNBool)object).getTimed();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_CPNBool_type") :
			getString("_UI_CPNBool_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CPNBool.class)) {
