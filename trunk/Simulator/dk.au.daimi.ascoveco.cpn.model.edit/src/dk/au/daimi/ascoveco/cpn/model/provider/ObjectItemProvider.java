...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.Object} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectItemProvider
	...
	protected void addPagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Object_page_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Object_page_feature", "_UI_Object_type"),
				 ModelPackage.Literals.OBJECT__PAGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphicsPackage.Literals.HAS_GRAPHICS__GRAPHICS);
	...
	public String getText(Object object) {
		String label = ((dk.au.daimi.ascoveco.cpn.model.Object)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(dk.au.daimi.ascoveco.cpn.model.Object.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphicsPackage.Literals.HAS_GRAPHICS__GRAPHICS,
				 GraphicsFactory.eINSTANCE.createAnnotationGraphics()));

		newChildDescriptors.add
			(createChildParameter
				(GraphicsPackage.Literals.HAS_GRAPHICS__GRAPHICS,
				 GraphicsFactory.eINSTANCE.createArcGraphics()));

		newChildDescriptors.add
			(createChildParameter
				(GraphicsPackage.Literals.HAS_GRAPHICS__GRAPHICS,
				 GraphicsFactory.eINSTANCE.createNodeGraphics()));
