 ...
 * @author michael
 */
public interface Arc extends HLArcAddin, HasId {
	/**
	...
	/**
	 * Sets the value of the '{@link dk.au.daimi.ascoveco.cpn.model.Arc#getSource <em>Source</em>}' reference. <!--
	...
	/**
	 * Sets the value of the '{@link dk.au.daimi.ascoveco.cpn.model.Arc#getTarget <em>Target</em>}' reference. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link dk.au.daimi.ascoveco.cpn.model.Arc#getPage <em>Page</em>}' container reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
