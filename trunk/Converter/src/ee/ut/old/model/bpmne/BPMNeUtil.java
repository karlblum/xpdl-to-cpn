...
public class BPMNeUtil {
	 ...
	 * 
	 * @param page Where to add a new place
	 ...
	 * 
	 * @param page Where to add a new transition
	 ...
	 * 
	 * @param page The page where to add arc
	 * @param place Place from where the arc comes
	 * @param trans Transition where the arc goes
	 * @param annot
	 * @return
	 */
	 ...
	 * 
	 * @param page The page where to add arc
	 * @param trans Transition where the arc comes
	 * @param place Place from where the arc goes
	 * @param annot
	 * @return
	 */
