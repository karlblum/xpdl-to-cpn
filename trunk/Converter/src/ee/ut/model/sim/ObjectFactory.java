 ...
 * generated in the ee.ut.model.sim package. 
...
public class ObjectFactory {
    ...
    private final static QName _SimulationData_QNAME = new QName("", "SimulationData");
    private final static QName _GateRef_QNAME = new QName("", "GateRef");
    private final static QName _MessageEvents_QNAME = new QName("", "MessageEvents");
    private final static QName _SimulationProfile_QNAME = new QName("", "SimulationProfile");
    private final static QName _Resources_QNAME = new QName("", "Resources");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ee.ut.model.sim
     * 
     */
    ...
    /**
     * Create an instance of {@link MessageEvents }
     * 
     */
    public MessageEvents createMessageEvents() {
    ...
    public JAXBElement<Gateways> createGateways(Gateways value) {
        return new JAXBElement<Gateways>(_Gateways_QNAME, Gateways.class, null, value);
    }
    ...
    public JAXBElement<GateRefs> createGateRefs(GateRefs value) {
        return new JAXBElement<GateRefs>(_GateRefs_QNAME, GateRefs.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link SimulationData }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "", name = "SimulationData")
    public JAXBElement<SimulationData> createSimulationData(SimulationData value) {
        return new JAXBElement<SimulationData>(_SimulationData_QNAME, SimulationData.class, null, value);
    }
    ...
    public JAXBElement<GateRef> createGateRef(GateRef value) {
        return new JAXBElement<GateRef>(_GateRef_QNAME, GateRef.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "MessageEvents")
    public JAXBElement<Object> createMessageEvents(Object value) {
        return new JAXBElement<Object>(_MessageEvents_QNAME, Object.class, null, value);
    }
    ...
    public JAXBElement<Object> createSimulationProfile(Object value) {
        return new JAXBElement<Object>(_SimulationProfile_QNAME, Object.class, null, value);
    }
    ...
    public JAXBElement<Object> createResources(Object value) {
        return new JAXBElement<Object>(_Resources_QNAME, Object.class, null, value);
    }
