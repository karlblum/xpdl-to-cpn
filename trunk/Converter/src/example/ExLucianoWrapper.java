...
public class ExLucianoWrapper {
	...
	public static void printNode(Node n) {
		...
		// n.getPosition().y, n.getBoundingBox().height,
		// n.getBoundingBox().width);
	}

	public static void doLayouting2(Page page) {
		...
		for (Place p : page.getPlaceArray()) {
			...
			pos.setX(Double.toString(getRandom(1500)));
			pos.setY(Double.toString(getRandom(1500)));
			p.setPosattr(pos);
