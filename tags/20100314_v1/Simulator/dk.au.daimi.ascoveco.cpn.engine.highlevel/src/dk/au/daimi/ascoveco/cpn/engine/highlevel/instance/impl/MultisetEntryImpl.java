...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Multiset Entry</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.engine.highlevel.instance.impl.MultisetEntryImpl#getCoefficient <em>Coefficient</em>}</li>
 *   <li>{@link dk.au.daimi.ascoveco.cpn.engine.highlevel.instance.impl.MultisetEntryImpl#getValueAsString <em>Value As String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MultisetEntryImpl extends EObjectImpl implements MultisetEntry {
	...
	protected EClass eStaticClass() {
		return InstancePackage.Literals.MULTISET_ENTRY;
	}
	...
	public void setCoefficient(int newCoefficient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.MULTISET_ENTRY__COEFFICIENT, oldCoefficient, coefficient));
	}
	...
	public void setValueAsString(String newValueAsString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.MULTISET_ENTRY__VALUE_AS_STRING, oldValueAsString, valueAsString));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InstancePackage.MULTISET_ENTRY__COEFFICIENT:
				return getCoefficient();
			case InstancePackage.MULTISET_ENTRY__VALUE_AS_STRING:
	...
	public boolean equals(final Object other) {
		...
		return o.getCoefficient() == getCoefficient() && getValueAsString().equals(o.getValueAsString());
	}
} // MultisetEntryImpl
