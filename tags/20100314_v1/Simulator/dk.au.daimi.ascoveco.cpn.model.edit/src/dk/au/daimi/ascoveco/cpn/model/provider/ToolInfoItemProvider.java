...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.ToolInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolInfoItemProvider
	 ...
	 * @generated
	 */
	public ToolInfoItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ToolInfo"));
	}
	...
	public String getText(Object object) {
		String label = ((ToolInfo)object).getTool();
		return label == null || label.length() == 0 ?
			getString("_UI_ToolInfo_type") :
			getString("_UI_ToolInfo_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ToolInfo.class)) {
