...
/**
 * This is the item provider adapter for a {@link dk.au.daimi.ascoveco.cpn.model.Arc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArcItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addHlinscriptionPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HLArcAddin_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HLArcAddin_type_feature", "_UI_HLArcAddin_type"),
				 ModelPackage.Literals.HL_ARC_ADDIN__TYPE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Hlinscription feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHlinscriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.ARC__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.ARC__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_page_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_page_feature", "_UI_Arc_type"),
				 ModelPackage.Literals.ARC__PAGE,
				 true,
				 false,
				 true,
				 null,
